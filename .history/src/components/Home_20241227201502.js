...
<div className="card-container">
  ...
  >
    <div className="slider" style={{ "--quantity": 4 }}>
      <a href="/chatbot" className="item" style={{ "--position": 1 }}>
        <div className="card">
          <img src="/images/Chatbot.jpg" alt="Chatbot" className="card-image" height: />
      ...
      <a href="/personal-assistant" className="item" style={{ "--position": 2 }}>
        <div className="card">
          <img src="images/personlassistant.jpg" alt="Personal Assistant" className="card-image" height="40px" width="6 height:px" />
          <div className="card-content">
